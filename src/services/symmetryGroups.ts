...
export const GENERATORS: Record<string, Matrix3x3[]> = {
  ...
  "-6m2": [multiply(getRotationZ(60), inversion), getRotationX(180)],
  ...
  "-6m21'": [multiply(getRotationZ(60), inversion), getRotationX(180), timeReversal],
  ...
  "6'/m'mm'": [multiply(getRotationZ(60), timeReversal), getRotationX(180), inversion],
